    ...
    <div class="container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-8 text-justif">
          ...
          <p>Furthermore, StorePredictor has the prowess to decipher intricate consumer behavior patterns. It examines variables such as past purchases, browsing habits, demographics, and external factors like economic indicators and social trends. Armed with this multifaceted understanding, businesses can tailor their marketing efforts, personalize user experiences, and craft promotions that resonate authentically with their target audience.</p>
          ...
          <p>Develope since 7/2021 after success in a Startup Incubator in Technicom, part of TUKE university in Košice.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
